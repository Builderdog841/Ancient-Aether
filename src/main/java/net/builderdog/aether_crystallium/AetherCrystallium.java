...
public class AetherCrystallium {
    ...
    private void commonSetup(final FMLCommonSetupEvent event) {
        ...
        event.enqueueWork(() -> {
            Regions.register(new ModRegion(new ResourceLocation(MOD_ID, "aether_crystallium"), 3));
    ...
    private void addCreative(CreativeModeTabEvent.BuildContents event) {
        if(event.getTab() == ModCreativeModeTabs.AETHER_CRYSTALLIUM_TAB)  {
            ...
            event.accept(ModBlocks.FIELDSPROUT_LOG);
            event.accept(ModBlocks.FIELDSPROUT_LOG_WALL);
            event.accept(ModBlocks.FIELDSPROUT_WOOD);
            event.accept(ModBlocks.FIELDSPROUT_WOOD_WALL);
            event.accept(ModBlocks.STRIPPED_FIELDSPROUT_LOG);
            event.accept(ModBlocks.STRIPPED_FIELDSPROUT_LOG_WALL);
            event.accept(ModBlocks.STRIPPED_FIELDSPROUT_WOOD);
            event.accept(ModBlocks.STRIPPED_FIELDSPROUT_WOOD_WALL);
            event.accept(ModBlocks.FIELDSPROUT_PLANKS);
            event.accept(ModBlocks.FIELDSPROUT_STAIRS);
            event.accept(ModBlocks.FIELDSPROUT_SLAB);
            event.accept(ModBlocks.FIELDSPROUT_FENCE);
            event.accept(ModBlocks.FIELDSPROUT_FENCE_GATE);
            event.accept(ModBlocks.FIELDSPROUT_DOOR);
            event.accept(ModBlocks.FIELDSPROUT_TRAPDOOR);
            event.accept(ModBlocks.FIELDSPROUT_PRESSURE_PLATE);
            event.accept(ModBlocks.FIELDSPROUT_BUTTON);
            event.accept(ModBlocks.FIELDSPROUT_SIGN);
            ...
            event.accept(ModBlocks.GREEN_FIELDSPROUT_LEAVES);
            event.accept(ModBlocks.PINK_FIELDSPROUT_LEAVES);
            event.accept(ModBlocks.HIGHLANDS_PINE_SAPLING);
            event.accept(ModBlocks.SUNROOT_SAPLING);
            event.accept(ModBlocks.GREEN_FIELDSPROUT_SAPLING);
            event.accept(ModBlocks.PINK_FIELDSPROUT_SAPLING);
            ...
            event.accept(ModItems.AMBER_BALL);
