...
public class AetherCrystallium {
    ...
    private void addCreative(CreativeModeTabEvent.BuildContents event) {
        if(event.getTab() == ModCreativeModeTabs.AETHER_CRYSTALLIUM_TAB)  {
            ...
            event.accept(ModBlocks.SAKURA_LOG);
            event.accept(ModBlocks.SAKURA_LOG_WALL);
            event.accept(ModBlocks.SAKURA_WOOD);
            event.accept(ModBlocks.SAKURA_WOOD_WALL);
            event.accept(ModBlocks.STRIPPED_SAKURA_LOG);
            event.accept(ModBlocks.STRIPPED_SAKURA_LOG_WALL);
            event.accept(ModBlocks.STRIPPED_SAKURA_WOOD);
            event.accept(ModBlocks.STRIPPED_SAKURA_WOOD_WALL);
            event.accept(ModBlocks.SAKURA_PLANKS);
            event.accept(ModBlocks.SAKURA_STAIRS);
            event.accept(ModBlocks.SAKURA_SLAB);
            event.accept(ModBlocks.SAKURA_FENCE);
            event.accept(ModBlocks.SAKURA_FENCE_GATE);
            event.accept(ModBlocks.SAKURA_DOOR);
            event.accept(ModBlocks.SAKURA_TRAPDOOR);
            event.accept(ModBlocks.SAKURA_PRESSURE_PLATE);
            event.accept(ModBlocks.SAKURA_BUTTON);
            event.accept(ModBlocks.SAKURA_SIGN);
