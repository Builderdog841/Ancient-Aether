...
public class ModWoodTypes {
    ...
    public static final BlockSetType SAKURA_BLOCK_SET = new BlockSetType(AetherCrystallium.MOD_ID + "sakura_pine");
    public static final WoodType SAKURA = new WoodType(AetherCrystallium.MOD_ID + "sakura_pine", SAKURA_BLOCK_SET);
}