...
import net.builderdog.aether_crystallium.worldgen.foliageplacer.FrostpineFoliagePlacer;
...
public class ModConfiguredFeatures {
    public static final ResourceKey<ConfiguredFeature<?, ?>> FROSTPINE_KEY = registerKey("frostpine");
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, FROSTPINE_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                        BlockStateProvider.simple(ModBlocks.FROSTPINE_LOG.get()),
                        new StraightTrunkPlacer(5, 7, 3),
                        BlockStateProvider.simple(ModBlocks.FROSTPINE_LEAVES.get()),
                        new FrostpineFoliagePlacer(ConstantInt.of(1), ConstantInt.ZERO, ConstantInt.of(1)),
