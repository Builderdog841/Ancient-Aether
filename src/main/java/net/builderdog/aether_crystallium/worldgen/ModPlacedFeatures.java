...
public class ModPlacedFeatures {
    public static final ResourceKey<PlacedFeature> FROSTPINE_KEY = createKey("frostpine_placed");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, FROSTPINE_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.FROSTPINE_KEY),
                VegetationPlacements.treePlacement(PlacementUtils.countExtra(3,0.1f,2), ModBlocks.FROSTPINE_SAPLING.get()));
