...
import net.builderdog.aether_crystallium.worldgen.features.aether_cactus.GiantCactusFeature;
import net.builderdog.aether_crystallium.worldgen.features.aether_cactus.LargeCactusFeature;
