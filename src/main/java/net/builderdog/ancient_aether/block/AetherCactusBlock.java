...
public class AetherCactusBlock extends AetherDoubleDropBlock {
    ...
    public @Nullable BlockState getToolModifiedState(BlockState state, UseOnContext context, ToolAction toolAction, boolean simulate) {
        if (context.getItemInHand().getItem() instanceof AxeItem) {
            if (state.is(net.builderdog.ancient_aether.block.AncientAetherBlocks.AETHER_CACTUS.get())) {
                return AncientAetherBlocks.STRIPPED_AETHER_CACTUS.get().defaultBlockState();
            }
        }
