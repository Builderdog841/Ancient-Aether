...
public class AncientAetherWoodTypes {
    ...
    public static final BlockSetType SAKURA_BLOCK_SET = new BlockSetType(AncientAether.MOD_ID + "sakura_pine");
    public static final WoodType SAKURA = new WoodType(AncientAether.MOD_ID + "sakura_pine", SAKURA_BLOCK_SET);
}