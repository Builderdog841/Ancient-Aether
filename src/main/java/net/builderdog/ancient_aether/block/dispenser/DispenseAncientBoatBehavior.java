...
public class DispenseAncientBoatBehavior extends DefaultDispenseItemBehavior {
    private final DefaultDispenseItemBehavior defaultDispenseItemBehavior = new DefaultDispenseItemBehavior();
    private final boolean isChestBoat;

    public DispenseAncientBoatBehavior() {
        this(false);
    }

    public DispenseAncientBoatBehavior(boolean isChestBoat) {
    ...
    public @NotNull ItemStack execute(BlockSource source, @NotNull ItemStack stack) {
        ...
        Boat boat = (isChestBoat ? new AncientBoat(level, width, x, y) : new SkyrootBoat(level, width, x, y));
