...
public abstract class AncientAetherWhirlyParticle<T extends AbstractVeloxWhirlwind> extends TextureSheetParticle {
    protected static final TargetingConditions TARGET_CONDITION = TargetingConditions.forNonCombat();
    protected AbstractVeloxWhirlwind whirlwind;
    protected SpriteSet animatedSprite;

    public AncientAetherWhirlyParticle(ClientLevel level, double xCoord, double yCoord, double zCoord, double xSpeed, double ySpeed, double zSpeed, SpriteSet sprite) {
