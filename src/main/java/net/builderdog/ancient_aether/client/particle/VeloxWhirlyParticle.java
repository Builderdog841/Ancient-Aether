...
public class VeloxWhirlyParticle extends AncientAetherWhirlyParticle<VeloxWhirlwind> {
    public VeloxWhirlyParticle(ClientLevel level, double xCoord, double yCoord, double zCoord, double xSpeed, double ySpeed, double zSpeed, SpriteSet sprite) {
    ...
    @Override
    public Class<VeloxWhirlwind> getWhirlwindType() {
        return VeloxWhirlwind.class;
    }
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType>
    {
        ...
        public Particle createParticle(@Nonnull SimpleParticleType particleType, @Nonnull ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            VeloxWhirlyParticle passiveWhirlyParticle = new VeloxWhirlyParticle(level, x, y, z, xSpeed, ySpeed, zSpeed, spriteSet);
