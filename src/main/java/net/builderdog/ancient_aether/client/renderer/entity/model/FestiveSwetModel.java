...
public class FestiveSwetModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    public static LayerDefinition createInnerBodyLayer() {
        MeshDefinition meshdefinition = new MeshDefinition();
        PartDefinition partdefinition = meshdefinition.getRoot();
        partdefinition.addOrReplaceChild("inner_layer", CubeListBuilder.create()
        ...
        partdefinition.addOrReplaceChild("candy_cane_stem_r1", CubeListBuilder.create()
                .texOffs(49, 14).addBox(0.0F, -7.0F, -2.0F, 3.0F, 15.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(37, 22).addBox(-7.0F, -7.0F, -2.0F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(23, 26).addBox(-4.0F, -7.0F, -2.0F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 16.0F, 0.0F, 0.0F, 0.0F, 0.7854F));
