...
public class WyndZephyrModel extends EntityModel<WyndZephyr> {
    ...
    public WyndZephyrModel(ModelPart model) {
    ...
    @Override
    public void setupAnim(@Nonnull WyndZephyr wyndZephyr, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
