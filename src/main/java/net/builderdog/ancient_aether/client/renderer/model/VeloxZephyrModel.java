...
public class VeloxZephyrModel extends EntityModel<VeloxZephyr> {
    ...
    public VeloxZephyrModel(ModelPart model) {
    ...
    @Override
    public void setupAnim(@Nonnull VeloxZephyr veloxzephyr, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
