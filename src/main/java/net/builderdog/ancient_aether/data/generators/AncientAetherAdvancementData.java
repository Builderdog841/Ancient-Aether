    ...
    public static class AncientAetherAdvancements implements AdvancementGenerator {
        ...
        public void generate(HolderLookup.@NotNull Provider provider, @NotNull Consumer<AdvancementHolder> consumer, @NotNull ExistingFileHelper existingFileHelper) {
            Advancement.Builder.advancement()
                    ...
                    .addCriterion("sun_forest", PlayerTrigger.TriggerInstance.located(LocationPredicate.Builder.inBiome(AncientAetherBiomes.SUN_FOREST)))
                    .addCriterion("wyndcap_taiga", PlayerTrigger.TriggerInstance.located(LocationPredicate.Builder.inBiome(AncientAetherBiomes.WYNDCAP_TAIGA)))
                    .addCriterion("festive_wyndcap_taiga", PlayerTrigger.TriggerInstance.located(LocationPredicate.Builder.inBiome(AncientAetherBiomes.FESTIVE_WYNDCAP_TAIGA)))
                    .addCriterion("wyndcap_highland", PlayerTrigger.TriggerInstance.located(LocationPredicate.Builder.inBiome(AncientAetherBiomes.WYNDCAP_HIGHLAND)))
                    .addCriterion("wyndcap_peaks", PlayerTrigger.TriggerInstance.located(LocationPredicate.Builder.inBiome(AncientAetherBiomes.WYNDCAP_PEAKS)))
                    .addCriterion("skyroot_jungle", PlayerTrigger.TriggerInstance.located(LocationPredicate.Builder.inBiome(AncientAetherBiomes.WYNDCAP_HIGHLAND)))
                    .addCriterion("sakura_jungle", PlayerTrigger.TriggerInstance.located(LocationPredicate.Builder.inBiome(AncientAetherBiomes.WYNDCAP_PEAKS)))
                    .addCriterion("elevated_clearing", PlayerTrigger.TriggerInstance.located(LocationPredicate.Builder.inBiome(AncientAetherBiomes.ELEVATED_CLEARING)))
                    .addCriterion("elevated_forest", PlayerTrigger.TriggerInstance.located(LocationPredicate.Builder.inBiome(AncientAetherBiomes.ELEVATED_FOREST)))
                    .addCriterion("sky_lake", PlayerTrigger.TriggerInstance.located(LocationPredicate.Builder.inBiome(AncientAetherBiomes.SKY_LAKE)))
                    .addCriterion("holystone_caverns", PlayerTrigger.TriggerInstance.located(LocationPredicate.Builder.inBiome(AncientAetherBiomes.HOLYSTONE_CAVERNS)))
                    .addCriterion("frozen_caverns", PlayerTrigger.TriggerInstance.located(LocationPredicate.Builder.inBiome(AncientAetherBiomes.FROZEN_CAVERNS)))
            ...
            AdvancementHolder findSentryLaboratory = Advancement.Builder.advancement()
                    ...
                    .display(AncientAetherBlocks.WYND_SENTRY_STONE.get(),
                            ...
                            null,
                            AdvancementType.GOAL, true, true, false)
                    .addCriterion("sentry_laboratory", PlayerTrigger.TriggerInstance.located(LocationPredicate.Builder.inStructure(AncientAetherStructures.SENTRY_LABORATORY)))
