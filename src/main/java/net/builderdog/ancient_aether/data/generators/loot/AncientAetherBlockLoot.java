...
public class AncientAetherBlockLoot extends AncientAetherBlockLootSubProvider {
    ...
    protected void generate() {
        ...
        dropSelf(AncientAetherBlocks.ELEVETIA.get());
        ...
        dropSelf(AncientAetherBlocks.VALKYRIE_BRICKS.get());
        ...
        dropPottedContents(AncientAetherBlocks.POTTED_ELEVETIA.get());
        ...
        add(AncientAetherBlocks.SAKURA_LEAVES.get(), (leaves) -> droppingWithChancesAndSkyrootSticks(leaves, AncientAetherBlocks.SAKURA_SAPLING.get(), BlockLootAccessor.aether$getNormalLeavesSaplingChances()));

        add(AncientAetherBlocks.HIGHSPROOT_BOOKSHELF.get(), (bookshelf) -> createSingleItemTableWithSilkTouch(bookshelf, Items.BOOK, ConstantValue.exactly(3)));
        add(AncientAetherBlocks.SAKURA_BOOKSHELF.get(), (bookshelf) -> createSingleItemTableWithSilkTouch(bookshelf, Items.BOOK, ConstantValue.exactly(3)));
    }

    @Override
    public @NotNull Iterable<Block> getKnownBlocks() {
        return AncientAetherBlocks.BLOCKS.getEntries().stream().map(Supplier::get).collect(Collectors.toList());
    }
}