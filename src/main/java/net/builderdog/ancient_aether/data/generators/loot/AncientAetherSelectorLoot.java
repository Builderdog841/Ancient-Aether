    ...
    public void generate(BiConsumer<ResourceLocation, LootTable.Builder> builder) {
        ...
        builder.accept(AncientAetherLoot.SELECTORS_HOLYSTONE_VASE, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        ...
                        .add(LootTableReference.lootTableReference(AncientAetherLoot.SELECTORS_TRIMS_GENERIC).setWeight(1))
                ));
        ...
        builder.accept(AncientAetherLoot.SELECTORS_FROZEN_HOLYSTONE_VASE, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        ...
                        .add(LootTableReference.lootTableReference(AncientAetherLoot.SELECTORS_ACCESSORIES_SENTRY_LABORATORY).setWeight(1))
                ));
        ...
        builder.accept(AncientAetherLoot.SELECTORS_SENTRY_VASE, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        ...
                        .add(LootTableReference.lootTableReference(AncientAetherLoot.SELECTORS_ACCESSORIES_BRONZE_DUNGEON).setWeight(2))
                        .add(LootTableReference.lootTableReference(AncientAetherLoot.SELECTORS_TRIMS_GENERIC).setWeight(1))
        ...
        builder.accept(AncientAetherLoot.SELECTORS_GALE_VASE, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        ...
                        .add(LootItem.lootTableItem(AetherItems.ZANITE_GEMSTONE.get()).setWeight(7))
                        .add(LootItem.lootTableItem(AetherItems.ENCHANTED_DART_SHOOTER.get()).setWeight(1))
                        .add(LootItem.lootTableItem(AetherItems.WHITE_CAPE.get()).setWeight(1))
                ));
    }
}