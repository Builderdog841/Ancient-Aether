...
public class AncientChestLoot implements LootTableSubProvider {
    @Override
    public void generate(@NotNull BiConsumer<ResourceLocation, LootTable.Builder> builder) {

        builder.accept(AncientLoot.CHESTS_CAMP_GENERIC, LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 3.0F))
                        ...
                        .add(LootItem.lootTableItem(AncientItems.GRAPES.get()).apply(SetItemCountFunction.setCount(UniformGenerator.between(3.0F, 6.0F))))
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(0.0F, 1.0F))
                        .add(LootItem.lootTableItem(AncientBlocks.AMBROSIUM_CAMPFIRE.get()))
                )
        );

        builder.accept(AncientLoot.CHESTS_CAMP_SKYROOT, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 1.0F))
                        .add(LootTableReference.lootTableReference(AncientLoot.CHESTS_CAMP_GENERIC))
                )
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(0.0F, 1.0F))
        ...
        builder.accept(AncientLoot.CHESTS_CAMP_WYNDCAPS, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 1.0F))
                        .add(LootTableReference.lootTableReference(AncientLoot.CHESTS_CAMP_GENERIC))
                )
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(0.0F, 1.0F))
                        .add(LootItem.lootTableItem(AncientBlocks.FLUFFALO_WOOL.get()).apply(SetItemCountFunction.setCount(UniformGenerator.between(4.0F, 8.0F))))
                )
        );

        builder.accept(AncientLoot.CHESTS_SETTLEMENT_SKYROOT_GENERIC, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(6.0F, 9.0F))
                        ...
                        .add(LootItem.lootTableItem(AncientItems.GRAPES.get()).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(3.0F, 6.0F))))
        ...
        builder.accept(AncientLoot.CHESTS_SETTLEMENT_SKYROOT_SHOP, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 1.0F))
                        .add(LootTableReference.lootTableReference(AncientLoot.CHESTS_SETTLEMENT_SKYROOT_GENERIC))
                )
        ...
        builder.accept(AncientLoot.CHESTS_SETTLEMENT_SKYROOT_LIBRARY, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 1.0F))
                        .add(LootTableReference.lootTableReference(AncientLoot.CHESTS_SETTLEMENT_SKYROOT_GENERIC))
                )
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 2.0F))
        ...
        builder.accept(AncientLoot.CHESTS_SETTLEMENT_SECRET, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 1.0F))
        ...
        builder.accept(AncientLoot.CHESTS_DUNGEON_ARMOR_TRIMS, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 1.0F))
                        .add(LootItem.lootTableItem(AncientItems.WYND_ARMOR_TRIM_SMITHING_TEMPLATE.get()))
                        .add(LootItem.lootTableItem(AncientItems.WHALE_ARMOR_TRIM_SMITHING_TEMPLATE.get()))
                        .add(LootItem.lootTableItem(AncientItems.ASCENDED_ARMOR_TRIM_SMITHING_TEMPLATE.get()))
                )
        );

        builder.accept(AncientLoot.CHESTS_DUNGEON_MOA_EGGS_COMMON, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 1.0F))
                        .add(LootItem.lootTableItem(AetherItems.BLUE_MOA_EGG.get()).setWeight(3))
                        .add(LootItem.lootTableItem(AncientItems.TURQUOISE_MOA_EGG.get()).setWeight(2))
                        .add(LootItem.lootTableItem(AncientItems.SKY_BLUE_MOA_EGG.get()))
                )
        );

        builder.accept(AncientLoot.CHESTS_DUNGEON_MOA_EGGS_UNCOMMON, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 1.0F))
                        .add(LootItem.lootTableItem(AetherItems.WHITE_MOA_EGG.get()).setWeight(4))
                        .add(LootItem.lootTableItem(AncientItems.TEAL_MOA_EGG.get()).setWeight(2))
                        .add(LootItem.lootTableItem(AncientItems.LAVENDER_MOA_EGG.get()).setWeight(2))
                )
        );

        builder.accept(AncientLoot.CHESTS_DUNGEON_MOA_EGGS_RARE, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 1.0F))
                        .add(LootItem.lootTableItem(AetherItems.BLACK_MOA_EGG.get()).setWeight(4))
                        .add(LootItem.lootTableItem(AncientItems.BURGUNDY_MOA_EGG.get()).setWeight(2))
                        .add(LootItem.lootTableItem(AncientItems.SAKURA_MOA_EGG.get()))
                        .add(LootItem.lootTableItem(AncientItems.VIOLET_MOA_EGG.get()))
                )
        );

        builder.accept(AncientLoot.CHESTS_DUNGEON_BRONZE_DUNGEON, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 1.0F))
                        .add(LootTableReference.lootTableReference(AncientLoot.CHESTS_DUNGEON_BRONZE_DUNGEON_LOOT).setWeight(3))
                        .add(LootTableReference.lootTableReference(AncientLoot.CHESTS_DUNGEON_BRONZE_DUNGEON_JUNK).setWeight(2))
                        .add(LootTableReference.lootTableReference(AncientLoot.CHESTS_DUNGEON_BRONZE_DUNGEON_SPECIAL).setWeight(1))
                )
        );

        builder.accept(AncientLoot.CHESTS_DUNGEON_BRONZE_DUNGEON_LOOT, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 2.0F))
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 2.0F))
                        ...
                        .add(LootItem.lootTableItem(AncientItems.PINK_CAPE.get()).setWeight(2))
                        ...
                        .add(LootTableReference.lootTableReference(AncientLoot.CHESTS_DUNGEON_MOA_EGGS_COMMON).setWeight(2))
                        .add(LootTableReference.lootTableReference(AncientLoot.CHESTS_DUNGEON_ARMOR_TRIMS).setWeight(2))
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 3.0F))
                        ...
                        .add(LootItem.lootTableItem(AncientItems.GRAPES.get()).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F))))
                        .add(LootItem.lootTableItem(AetherItems.SKYROOT_POISON_BUCKET.get()))
                )
        );

        builder.accept(AncientLoot.CHESTS_DUNGEON_BRONZE_DUNGEON_JUNK, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 2.0F))
        ...
        builder.accept(AncientLoot.CHESTS_DUNGEON_BRONZE_DUNGEON_SPECIAL, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 2.0F))
                        .add(LootItem.lootTableItem(AetherItems.AMBROSIUM_SHARD.get()).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 5.0F))))
                        .add(LootItem.lootTableItem(AetherItems.GOLDEN_AMBER.get()).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(3.0F, 6.0F))))
                        .add(LootItem.lootTableItem(AetherItems.ZANITE_GEMSTONE.get()).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 1.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherItems.GOLDEN_DART_SHOOTER.get()).setWeight(2))
                        .add(LootTableReference.lootTableReference(AncientLoot.CHESTS_DUNGEON_MOA_EGGS_COMMON).setWeight(2))
                        .add(LootTableReference.lootTableReference(AncientLoot.CHESTS_DUNGEON_ARMOR_TRIMS))
                )
        );

        builder.accept(AncientLoot.CHESTS_DUNGEON_BRONZE_DUNGEON_LIBRARY, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 2.0F))
        ...
        builder.accept(AncientLoot.CHESTS_DUNGEON_BRONZE_DUNGEON_REWARD, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(5.0F, 9.0F))
                        ...
                        .add(LootItem.lootTableItem(AncientItems.MOSAIC_ARMOR_TRIM_SMITHING_TEMPLATE.get()).setWeight(3))
                        .add(LootItem.lootTableItem(AncientItems.HERMES_RING.get()).setWeight(3))
                        .add(LootItem.lootTableItem(AncientItems.HERMES_PENDANT.get()).setWeight(3))
        ...
        builder.accept(AncientLoot.CHESTS_DUNGEON_SENTRY_LABORATORY, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 1.0F))
                        .add(LootTableReference.lootTableReference(AncientLoot.CHESTS_DUNGEON_SENTRY_LABORATORY_LOOT).setWeight(4))
                        .add(LootTableReference.lootTableReference(AncientLoot.CHESTS_DUNGEON_SENTRY_LABORATORY_SUPPLIES).setWeight(2))
                        .add(LootTableReference.lootTableReference(AncientLoot.CHESTS_DUNGEON_SENTRY_LABORATORY_MISCELLANEOUS).setWeight(2))
                )
        );

        builder.accept(AncientLoot.CHESTS_DUNGEON_SENTRY_LABORATORY_LOOT, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(2.0F, 4.0F))
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(0.0F, 2.0F))
                        ...
                        .add(LootTableReference.lootTableReference(AncientLoot.CHESTS_DUNGEON_MOA_EGGS_COMMON).setWeight(4))
                        ...
                        .add(LootItem.lootTableItem(AncientItems.MECHANICAL_ARMOR_TRIM_SMITHING_TEMPLATE.get()).setWeight(2))
        ...
        builder.accept(AncientLoot.CHESTS_DUNGEON_SENTRY_LABORATORY_SUPPLIES, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 2.0F))
                        .add(LootItem.lootTableItem(AetherItems.AMBROSIUM_SHARD.get()).setWeight(4).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F))))
                        .add(LootItem.lootTableItem(AetherBlocks.ICESTONE.get()).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
                        .add(LootItem.lootTableItem(AetherItems.ZANITE_GEMSTONE.get()).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 2.0F))
                        ...
                        .add(LootTableReference.lootTableReference(AncientLoot.CHESTS_DUNGEON_MOA_EGGS_COMMON))
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(3.0F, 5.0F))
                        ...
                        .add(LootItem.lootTableItem(AncientItems.FESTIVE_GUMMY_SWET.get()).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
        ...
        builder.accept(AncientLoot.CHESTS_DUNGEON_SENTRY_LABORATORY_MISCELLANEOUS, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 3.0F))
                        ...
                        .add(LootItem.lootTableItem(AncientBlocks.VIOLET_AERCLOUD.get()).setWeight(4).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 5.0F))))
                        .add(LootItem.lootTableItem(AncientBlocks.WIND_BLOWER.get()).setWeight(3))
                        .add(LootItem.lootTableItem(AncientBlocks.SLIDER_PROTOTYPE.get()))
        ...
        builder.accept(AncientLoot.CHESTS_DUNGEON_SENTRY_LABORATORY_REWARD, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(6.0F, 9.0F))
                        .add(LootItem.lootTableItem(AncientItems.HERMES_RING.get()).setWeight(3))
                        .add(LootItem.lootTableItem(AncientItems.HERMES_PENDANT.get()).setWeight(3))
                        ...
                        .add(LootItem.lootTableItem(AncientItems.MECHANICAL_ARMOR_TRIM_SMITHING_TEMPLATE.get()).setWeight(3))
                        ...
                        .add(LootItem.lootTableItem(AetherBlocks.PRESENT.get()).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                        .add(LootItem.lootTableItem(AncientItems.ANCIENT_RUNE.get()).setWeight(2))
                        .add(LootItem.lootTableItem(AncientItems.WARRIOR_RING.get()).setWeight(2))
                        .add(LootItem.lootTableItem(AncientItems.WARRIOR_PENDANT.get()).setWeight(2))
                        .add(LootTableReference.lootTableReference(AncientLoot.CHESTS_DUNGEON_ARMOR_TRIMS))
                        .add(LootItem.lootTableItem(AetherItems.ZANITE_HELMET.get()))
                        .add(LootItem.lootTableItem(AetherItems.ZANITE_CHESTPLATE.get()))
                        .add(LootItem.lootTableItem(AetherItems.ZANITE_LEGGINGS.get()))
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 1.0F))
                        .add(LootItem.lootTableItem(AncientItems.SHIELD_OF_INEBRIATION.get()))
                        .add(LootItem.lootTableItem(AncientItems.SHIELD_OF_REMEDIATION.get()))
                )
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(2.0F, 3.0F))
                        .add(LootItem.lootTableItem(AncientItems.FESTIVE_GUMMY_SWET.get()).setWeight(4).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F))))
                        .add(LootItem.lootTableItem(AetherItems.ENCHANTED_BERRY.get()).apply(SetItemCountFunction.setCount(UniformGenerator.between(3.0F, 6.0F))))
