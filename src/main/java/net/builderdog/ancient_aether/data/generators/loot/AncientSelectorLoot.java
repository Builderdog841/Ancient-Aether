...
public class AncientSelectorLoot implements LootTableSubProvider {
    @Override
    public void generate(BiConsumer<ResourceLocation, LootTable.Builder> builder) {
        builder.accept(AncientLoot.SELECTORS_ACCESSORIES_GENERIC, LootTable.lootTable()
        ...
        builder.accept(AncientLoot.SELECTORS_ACCESSORIES_BRONZE_DUNGEON, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        ...
                        .add(LootItem.lootTableItem(AncientItems.PINK_CAPE.get()).setWeight(4))
        ...
        builder.accept(AncientLoot.SELECTORS_ACCESSORIES_SILVER_DUNGEON, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        ...
                        .add(LootItem.lootTableItem(AncientItems.HERMES_RING.get()))
                        .add(LootItem.lootTableItem(AncientItems.HERMES_PENDANT.get()))
                        .add(LootItem.lootTableItem(AetherItems.MUSIC_DISC_AETHER_TUNE.get()))
                ));

        builder.accept(AncientLoot.SELECTORS_ACCESSORIES_GOLD_DUNGEON, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
        ...
        builder.accept(AncientLoot.SELECTORS_ACCESSORIES_ANCIENT_DUNGEON, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        .add(LootItem.lootTableItem(AncientItems.AERONAUTIC_DART_SHOOTER.get()).setWeight(2))
                        .add(LootItem.lootTableItem(Items.MUSIC_DISC_STRAD).setWeight(2))
                        .add(LootItem.lootTableItem(AetherItems.GOLDEN_PARACHUTE.get()))
                        .add(LootItem.lootTableItem(AetherItems.MUSIC_DISC_AETHER_TUNE.get()))
                ));

        builder.accept(AncientLoot.SELECTORS_ACCESSORIES_SENTRY_LABORATORY, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
        ...
        builder.accept(AncientLoot.SELECTORS_TRIMS_GENERIC, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        .add(LootItem.lootTableItem(AncientItems.ANCIENT_RUNE.get()))
                        .add(LootItem.lootTableItem(AncientItems.WYND_ARMOR_TRIM_SMITHING_TEMPLATE.get()).setWeight(3))
                        .add(LootItem.lootTableItem(AncientItems.WHALE_ARMOR_TRIM_SMITHING_TEMPLATE.get()).setWeight(3))
                        .add(LootItem.lootTableItem(AncientItems.ASCENDED_ARMOR_TRIM_SMITHING_TEMPLATE.get()).setWeight(3))
                ));

        builder.accept(AncientLoot.SELECTORS_TRIMS_MYSTERIOUS, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        .add(LootItem.lootTableItem(AncientItems.ANCIENT_RUNE.get()))
                        .add(LootItem.lootTableItem(AncientItems.MYSTERIOUS_ARMOR_TRIM_SMITHING_TEMPLATE.get()).setWeight(9))
                ));

        builder.accept(AncientLoot.SELECTORS_TRIMS_MECHANICAL, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        .add(LootItem.lootTableItem(AncientItems.ANCIENT_RUNE.get()))
                        .add(LootItem.lootTableItem(AncientItems.MECHANICAL_ARMOR_TRIM_SMITHING_TEMPLATE.get()).setWeight(9))
                ));

        builder.accept(AncientLoot.SELECTORS_HOLYSTONE_VASE, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        ...
                        .add(LootTableReference.lootTableReference(AncientLoot.SELECTORS_TRIMS_GENERIC).setWeight(3))
                        .add(LootTableReference.lootTableReference(AncientLoot.SELECTORS_ACCESSORIES_GENERIC).setWeight(2))
                        .add(LootItem.lootTableItem(AetherItems.SKYROOT_REMEDY_BUCKET.get()))
                ));

        builder.accept(AncientLoot.SELECTORS_MOSSY_HOLYSTONE_VASE, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        ...
                        .add(LootItem.lootTableItem(AncientBlocks.VIOLET_AERCLOUD.get()).setWeight(5))
                        .add(LootTableReference.lootTableReference(AncientLoot.SELECTORS_TRIMS_MYSTERIOUS).setWeight(3))
        ...
        builder.accept(AncientLoot.SELECTORS_FROZEN_HOLYSTONE_VASE, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        ...
                        .add(LootItem.lootTableItem(AncientBlocks.VIOLET_AERCLOUD.get()).setWeight(7))
                        ...
                        .add(LootTableReference.lootTableReference(AncientLoot.SELECTORS_TRIMS_MECHANICAL).setWeight(3))
                        .add(LootItem.lootTableItem(AncientItems.FESTIVE_GUMMY_SWET.get()).setWeight(2))
                        ...
                        .add(LootTableReference.lootTableReference(AncientLoot.SELECTORS_ACCESSORIES_SENTRY_LABORATORY))
                ));

        builder.accept(AncientLoot.SELECTORS_SENTRY_VASE, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        ...
                        .add(LootItem.lootTableItem(AetherItems.ZANITE_GEMSTONE.get()).setWeight(7))
                        .add(LootItem.lootTableItem(AetherItems.HEALING_STONE.get()).setWeight(5))
                        .add(LootItem.lootTableItem(AncientItems.GRAPES.get()).setWeight(5))
                        .add(LootTableReference.lootTableReference(AncientLoot.SELECTORS_ACCESSORIES_BRONZE_DUNGEON).setWeight(3))
                        ...
                        .add(LootTableReference.lootTableReference(AncientLoot.SELECTORS_TRIMS_GENERIC))
                        .add(LootItem.lootTableItem(AetherItems.GOLDEN_DART_SHOOTER.get()))
                ));

        builder.accept(AncientLoot.SELECTORS_ANGELIC_VASE, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        ...
                        .add(LootItem.lootTableItem(AetherItems.WHITE_APPLE.get()).setWeight(7))
                        .add(LootItem.lootTableItem(AetherItems.ZANITE_GEMSTONE.get()).setWeight(7))
                        .add(LootItem.lootTableItem(AncientItems.GRAPES.get()).setWeight(7))
                        .add(LootItem.lootTableItem(AetherItems.AECHOR_PETAL.get()).setWeight(7))
                        ...
                        .add(LootTableReference.lootTableReference(AncientLoot.SELECTORS_ACCESSORIES_SILVER_DUNGEON).setWeight(2))
                        .add(LootTableReference.lootTableReference(AncientLoot.SELECTORS_TRIMS_GENERIC))
                        .add(LootItem.lootTableItem(AetherItems.ENCHANTED_DART_SHOOTER.get()))
                        .add(LootItem.lootTableItem(Items.NAME_TAG))
                ));

        builder.accept(AncientLoot.SELECTORS_HELLFIRE_VASE, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        .add(LootItem.lootTableItem(AetherItems.AMBROSIUM_SHARD.get()).setWeight(15))
                        ...
                        .add(LootTableReference.lootTableReference(AncientLoot.SELECTORS_ACCESSORIES_GOLD_DUNGEON).setWeight(2))
                        .add(LootTableReference.lootTableReference(AncientLoot.SELECTORS_TRIMS_GENERIC))
                        .add(LootItem.lootTableItem(AetherItems.ENCHANTED_DART_SHOOTER.get()))
        ...
        builder.accept(AncientLoot.SELECTORS_AEROGETIC_VASE, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        .add(LootItem.lootTableItem(AetherItems.AMBROSIUM_SHARD.get()).setWeight(10))
                        .add(LootItem.lootTableItem(AetherItems.ENCHANTED_DART.get()).setWeight(10))
                        ...
                        .add(LootItem.lootTableItem(AetherBlocks.ICESTONE.get()).setWeight(5))
                        .add(LootItem.lootTableItem(AetherItems.GOLDEN_AMBER.get()).setWeight(5))
                        .add(LootItem.lootTableItem(AncientItems.FESTIVE_GUMMY_SWET.get()).setWeight(3))
                        .add(LootItem.lootTableItem(AetherBlocks.AMBROSIUM_BLOCK.get()).setWeight(2))
                        .add(LootTableReference.lootTableReference(AncientLoot.SELECTORS_ACCESSORIES_ANCIENT_DUNGEON).setWeight(2))
                        .add(LootTableReference.lootTableReference(AncientLoot.SELECTORS_TRIMS_GENERIC))
                        .add(LootItem.lootTableItem(AetherBlocks.ENCHANTED_GRAVITITE.get()))
                ));

        builder.accept(AncientLoot.SELECTORS_GALE_VASE, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        .add(LootItem.lootTableItem(AetherItems.WHITE_APPLE.get()).setWeight(10))
                        .add(LootItem.lootTableItem(AetherItems.ENCHANTED_DART.get()).setWeight(10))
                        .add(LootItem.lootTableItem(Items.ARROW).setWeight(10))
