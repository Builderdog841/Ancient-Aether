...
public class AncientAetherOreFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        AncientAetherFeatureUtils.register(context, GRAVITY_GRAVEL_ORE, Feature.ORE, new OreConfiguration(gravityGravelOre, 64, 0f));
        AncientAetherFeatureUtils.register(context, AEROGEL_BLOBS, Feature.ORE, new OreConfiguration(aerogelOre, 32, 0f));
