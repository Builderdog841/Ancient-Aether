...
public class AncientAetherVegetationPlacements {
    ...
    public static final ResourceKey<PlacedFeature> AETHER_GRASS_WYNDCAPS_BONEMEAL = AncientAetherPlacementUtils.createKey("aether_grass_wyndcaps_bonemeal");
    public static final ResourceKey<PlacedFeature> AETHER_GRASS_ELEVATED_ISLANDS_BONEMEAL = AncientAetherPlacementUtils.createKey("aether_grass_elevated_islands_bonemeal");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        AncientAetherPlacementUtils.register(context, AETHER_GRASS_WYNDCAPS_BONEMEAL, configuredFeatures.getOrThrow(AncientAetherVegetationFeatures.SINGLE_PIECE_OF_FROZEN_SKY_GRASS), PlacementUtils.isEmpty());
        AncientAetherPlacementUtils.register(context, AETHER_GRASS_ELEVATED_ISLANDS_BONEMEAL, configuredFeatures.getOrThrow(AncientAetherVegetationFeatures.SINGLE_PIECE_OF_PALE_SKY_GRASS), PlacementUtils.isEmpty());
