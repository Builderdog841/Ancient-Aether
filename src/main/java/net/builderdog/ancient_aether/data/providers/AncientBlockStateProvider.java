...
public abstract class AncientBlockStateProvider extends AetherBlockStateProvider {
    public AncientBlockStateProvider(PackOutput output, String id, ExistingFileHelper helper) {
