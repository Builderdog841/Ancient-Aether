...
public abstract class AncientItemModelProvider extends AetherItemModelProvider {
    public AncientItemModelProvider(PackOutput output, String id, ExistingFileHelper helper) {
