...
public abstract class AncientRecipeProvider extends AetherRecipeProvider {
    public AncientRecipeProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, String id) {
    ...
    protected static void copyAetherSmithingTemplate(RecipeOutput consumer, ItemLike template, ItemLike block) {
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, template, 2)
                .define('#', AncientItems.VALKYRUM.get())
                .define('C', block)
                .define('S', template)
                .pattern("#S#")
                .pattern("#C#")
