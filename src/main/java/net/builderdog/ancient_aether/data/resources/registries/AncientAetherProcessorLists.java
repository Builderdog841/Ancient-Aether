    ...
    public static void bootstrap(BootstapContext<StructureProcessorList> context) {
        ...
        register(context, SENTRY_LABORATORY_BOSS_ROOM, ImmutableList.of(
                new RuleProcessor(ImmutableList.of(
                        ...
                        new ProcessorRule(new RandomBlockMatchTest(AetherBlocks.TREASURE_DOORWAY_CARVED_STONE.get(), 0.01F), AlwaysTrueTest.INSTANCE, AncientAetherBlocks.TREASURE_DOORWAY_WYND_SENTRY_STONE.get().defaultBlockState())
                )),
                new BossRoomProcessor()
        ));
