...
public class AncientProcessorLists {
    ...
    public static void bootstrap(BootstapContext<StructureProcessorList> context) {
        register(context, HOLYSTONE_RUIN, ImmutableList.of(
                new RuleProcessor(ImmutableList.of(
                        new ProcessorRule(new RandomBlockMatchTest(AetherBlocks.HOLYSTONE.get(), 0.4F), AlwaysTrueTest.INSTANCE, AncientFeatureStates.MOSSY_HOLYSTONE),
                        new ProcessorRule(new RandomBlockMatchTest(AncientBlocks.ANCIENT_HOLYSTONE_VASE.get(), 0.25F), AlwaysTrueTest.INSTANCE, Blocks.AIR.defaultBlockState()),
        ...
        register(context, MYSTERIOUS_HENGE, ImmutableList.of(
                new RuleProcessor(ImmutableList.of(
                        new ProcessorRule(new RandomBlockMatchTest(AncientBlocks.ANCIENT_MOSSY_HOLYSTONE_VASE.get(), 0.5F), AlwaysTrueTest.INSTANCE, Blocks.AIR.defaultBlockState()),
                        ...
                        new ProcessorRule(new RandomBlockMatchTest(AetherBlocks.HOLYSTONE.get(), 0.2F), AlwaysTrueTest.INSTANCE, AncientFeatureStates.MOSSY_HOLYSTONE),
        ...
        register(context, VALKYRIE_CAMP_SKYROOT, ImmutableList.of(
                new RuleProcessor(ImmutableList.of(
                        ...
                        new ProcessorRule(new RandomBlockMatchTest(AetherBlocks.POTTED_WHITE_FLOWER.get(), 0.15F), AlwaysTrueTest.INSTANCE, AncientBlocks.POTTED_SUNSET_ROSE.get().defaultBlockState()),
                        new ProcessorRule(new RandomBlockMatchTest(AetherBlocks.POTTED_WHITE_FLOWER.get(), 0.15F), AlwaysTrueTest.INSTANCE, AncientBlocks.POTTED_SKY_BLUES.get().defaultBlockState()),
        ...
        register(context, VALKYRIE_CAMP_WYNDCAPS, ImmutableList.of(
                new RuleProcessor(ImmutableList.of(
                        new ProcessorRule(new RandomBlockMatchTest(AetherBlocks.AETHER_GRASS_BLOCK.get(), 0.75F), AlwaysTrueTest.INSTANCE, AetherBlocks.AETHER_DIRT_PATH.get().defaultBlockState()),
                        new ProcessorRule(new RandomBlockMatchTest(Blocks.CHEST, 0.25F), AlwaysTrueTest.INSTANCE, Blocks.AIR.defaultBlockState()),
                        new ProcessorRule(new RandomBlockMatchTest(AncientBlocks.POTTED_WYND_THISTLE.get(), 0.3F), AlwaysTrueTest.INSTANCE, AncientBlocks.POTTED_SKY_BLUES.get().defaultBlockState()),
                        new ProcessorRule(new RandomBlockMatchTest(AncientBlocks.POTTED_WYND_THISTLE.get(), 0.2F), AlwaysTrueTest.INSTANCE, AetherBlocks.POTTED_BERRY_BUSH.get().defaultBlockState())
                )),
                new DoubleDropsProcessor(),
                new SurfaceRuleProcessor()
        ));
        register(context, VALKYRIE_SETTLEMENT_SKYROOT, ImmutableList.of(
                new RuleProcessor(ImmutableList.of(
                        new ProcessorRule(new RandomBlockMatchTest(AncientBlocks.GRAPE_VINE.get(), 0.5F), AlwaysTrueTest.INSTANCE, Blocks.AIR.defaultBlockState()),
                        new ProcessorRule(new RandomBlockMatchTest(AetherBlocks.HOLYSTONE.get(), 0.4F), AlwaysTrueTest.INSTANCE, AncientFeatureStates.MOSSY_HOLYSTONE),
        ...
        register(context, BRONZE_DUNGEON, ImmutableList.of(
                new RuleProcessor(ImmutableList.of(
                        new ProcessorRule(new TagMatchTest(AncientTags.Blocks.REPLACEABLE_DUNGEON_BLOCKS), new BlockMatchTest(Blocks.AIR), Blocks.AIR.defaultBlockState()),
                        new ProcessorRule(new TagMatchTest(AncientTags.Blocks.REPLACEABLE_DUNGEON_BLOCKS), new BlockMatchTest(Blocks.WATER), Blocks.WATER.defaultBlockState()),
                        new ProcessorRule(new TagMatchTest(AncientTags.Blocks.REPLACEABLE_DUNGEON_BLOCKS), new BlockMatchTest(AetherBlocks.COLD_AERCLOUD.get()), AetherFeatureStates.COLD_AERCLOUD),
                        ...
                        new ProcessorRule(new RandomBlockMatchTest(AncientBlocks.CARVED_TILES.get(), 0.03F), AlwaysTrueTest.INSTANCE, AncientBlocks.TRAPPED_CARVED_TILES.get().defaultBlockState()),
                        new ProcessorRule(new RandomBlockMatchTest(AetherBlocks.HOLYSTONE.get(), 0.4F), AlwaysTrueTest.INSTANCE, AncientFeatureStates.MOSSY_HOLYSTONE),
                        new ProcessorRule(new RandomBlockMatchTest(AncientBlocks.ANCIENT_SENTRY_VASE.get(), 0.75F), AlwaysTrueTest.INSTANCE, Blocks.AIR.defaultBlockState()),
        ...
        register(context, BRONZE_DUNGEON_BOSS_ROOM, ImmutableList.of(
                new RuleProcessor(ImmutableList.of(
                        new ProcessorRule(new TagMatchTest(AncientTags.Blocks.REPLACEABLE_BOSS_ROOM_BLOCKS), new BlockMatchTest(Blocks.AIR), Blocks.AIR.defaultBlockState()),
                        new ProcessorRule(new TagMatchTest(AncientTags.Blocks.REPLACEABLE_BOSS_ROOM_BLOCKS), new BlockMatchTest(Blocks.WATER), Blocks.WATER.defaultBlockState()),
                        new ProcessorRule(new TagMatchTest(AncientTags.Blocks.REPLACEABLE_BOSS_ROOM_BLOCKS), new BlockMatchTest(AetherBlocks.COLD_AERCLOUD.get()), AetherFeatureStates.COLD_AERCLOUD),
                        new ProcessorRule(new RandomBlockMatchTest(AetherBlocks.CARVED_STONE.get(), 0.01F), AlwaysTrueTest.INSTANCE, AetherBlocks.SENTRY_STONE.get().defaultBlockState()),
                        new ProcessorRule(new RandomBlockMatchTest(AncientBlocks.CARVED_TILES.get(), 0.03F), AlwaysTrueTest.INSTANCE, AncientBlocks.TRAPPED_CARVED_TILES.get().defaultBlockState()),
        ...
        register(context, SENTRY_LABORATORY, ImmutableList.of(
                new RuleProcessor(ImmutableList.of(
                        ...
                        new ProcessorRule(new RandomBlockMatchTest(AncientBlocks.ANCIENT_FROZEN_HOLYSTONE_VASE.get(), 0.25F), AlwaysTrueTest.INSTANCE, Blocks.AIR.defaultBlockState()),
                        new ProcessorRule(new RandomBlockMatchTest(AetherBlocks.CARVED_STONE.get(), 0.05F), AlwaysTrueTest.INSTANCE, AncientBlocks.WYND_SENTRY_STONE.get().defaultBlockState()),
                        new ProcessorRule(new RandomBlockMatchTest(AetherBlocks.HOLYSTONE_BRICKS.get(), 0.05F), AlwaysTrueTest.INSTANCE, AetherFeatureStates.HOLYSTONE),
        ...
        register(context, SENTRY_LABORATORY_BOSS_ROOM, ImmutableList.of(
                new RuleProcessor(ImmutableList.of(
                        new ProcessorRule(new RandomBlockMatchTest(AetherBlocks.LOCKED_CARVED_STONE.get(), 0.05F), AlwaysTrueTest.INSTANCE, AncientBlocks.LOCKED_WYND_SENTRY_STONE.get().defaultBlockState()),
                        new ProcessorRule(new RandomBlockMatchTest(AetherBlocks.TREASURE_DOORWAY_CARVED_STONE.get(), 0.05F), AlwaysTrueTest.INSTANCE, AncientBlocks.TREASURE_DOORWAY_WYND_SENTRY_STONE.get().defaultBlockState())
                )),
                new BossRoomProcessor()
        ));
        register(context, ANCIENT_DUNGEON, ImmutableList.of(
                new RuleProcessor(ImmutableList.of(
                        new ProcessorRule(new RandomBlockMatchTest(AncientBlocks.LOCKED_AEROGETIC_STONE.get(), 0.05F), AlwaysTrueTest.INSTANCE, AncientBlocks.AERONAUTIC_STONE.get().defaultBlockState()),
                        new ProcessorRule(new RandomBlockMatchTest(AncientBlocks.TREASURE_DOORWAY_AEROGETIC_STONE.get(), 0.05F), AlwaysTrueTest.INSTANCE, AncientBlocks.TREASURE_DOORWAY_AEROGETIC_STONE.get().defaultBlockState()),
