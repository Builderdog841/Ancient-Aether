...
public class AncientTrimMaterials {
    ...
    public static void bootstrap(BootstapContext<TrimMaterial> context) {
        register(context, VALKYRUM, AncientItems.VALKYRUM.get(), Style.EMPTY.withColor(0xDBB67F), 0.6F);
        register(context, ATMOSINE, AncientBlocks.ATMOSINE_CRYSTAL.get().asItem(), Style.EMPTY.withColor(0xFFB096), 1.0F);
    }
