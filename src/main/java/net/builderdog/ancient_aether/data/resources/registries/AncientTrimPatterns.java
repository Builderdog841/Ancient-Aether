...
public class AncientTrimPatterns extends TrimPatterns {
    ...
    public static void bootstrap(BootstapContext<TrimPattern> context) {
        register(context, AncientItems.WYND_ARMOR_TRIM_SMITHING_TEMPLATE.get(), WYND);
        register(context, AncientItems.WHALE_ARMOR_TRIM_SMITHING_TEMPLATE.get(), WHALE);
        register(context, AncientItems.ASCENDED_ARMOR_TRIM_SMITHING_TEMPLATE.get(), ASCENDED);
        register(context, AncientItems.MYSTERIOUS_ARMOR_TRIM_SMITHING_TEMPLATE.get(), MYSTERIOUS);
        register(context, AncientItems.MECHANICAL_ARMOR_TRIM_SMITHING_TEMPLATE.get(), MECHANICAL);
        register(context, AncientItems.MOSAIC_ARMOR_TRIM_SMITHING_TEMPLATE.get(), MOSAIC);
        register(context, AncientItems.ROYAL_ARMOR_TRIM_SMITHING_TEMPLATE.get(), ROYAL);
        register(context, AncientItems.SOLAR_ARMOR_TRIM_SMITHING_TEMPLATE.get(), SOLAR);
        register(context, AncientItems.ANCIENT_ARMOR_TRIM_SMITHING_TEMPLATE.get(), ANCIENT);
    }
