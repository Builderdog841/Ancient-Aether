...
public class AncientFeatureUtils {
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> configuredFeature) {
        AncientOreFeatures.bootstrap(configuredFeature);
        AncientMiscFeatures.bootstrap(configuredFeature);
        AncientTreeFeatures.bootstrap(configuredFeature);
        AncientVegetationFeatures.bootstrap(configuredFeature);
    }

    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(AncientAether.MODID, name));
    }
