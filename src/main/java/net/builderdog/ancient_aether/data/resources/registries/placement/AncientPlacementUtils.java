...
public class AncientPlacementUtils {

    public static void bootstrap(BootstapContext<PlacedFeature> placedFeature) {
        AncientOrePlacements.bootstrap(placedFeature);
        AncientVegetationPlacements.bootstrap(placedFeature);
        AncientMiscPlacements.bootstrap(placedFeature);
    }

    static ResourceKey<PlacedFeature> createKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(AncientAether.MODID, name));
    }
