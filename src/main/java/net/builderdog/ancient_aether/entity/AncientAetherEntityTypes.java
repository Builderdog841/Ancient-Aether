...
public class AncientAetherEntityTypes {
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES = DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, AncientAether.MODID);

    public static final RegistryObject<EntityType<Fluffalo>> FLUFFALO = ENTITY_TYPES.register("fluffalo", () -> EntityType.Builder.of(Fluffalo::new, MobCategory.CREATURE).sized(1.5F, 1.75F).clientTrackingRange(10).build("fluffalo"));
    ...
    public static final RegistryObject<EntityType<Slammroot>> SLAMMROOT = ENTITY_TYPES.register("slammroot", () -> EntityType.Builder.of(Slammroot::new, MobCategory.MONSTER).sized(2.0F, 2.0F).clientTrackingRange(16).build("slammroot"));
    public static final RegistryObject<EntityType<AeronauticLeaper>> AERONAUTIC_LEAPER = ENTITY_TYPES.register("aeronautic_leaper", () -> EntityType.Builder.of(AeronauticLeaper::new, MobCategory.MONSTER).sized(2.0F, 2.0F).clientTrackingRange(16).build("aeronautic_leaper"));
