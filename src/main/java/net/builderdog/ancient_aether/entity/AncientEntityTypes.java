...
public class AncientEntityTypes {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<AncientBoat>> BOAT = ENTITY_TYPES.register("boat", () -> EntityType.Builder.<AncientBoat>of(AncientBoat::new, MobCategory.MISC).sized(1.375F, 0.5625F).clientTrackingRange(10).build("boat"));
    public static final DeferredHolder<EntityType<?>, EntityType<AncientChestBoat>> CHEST_BOAT = ENTITY_TYPES.register("chest_boat", () -> EntityType.Builder.<AncientChestBoat>of(AncientChestBoat::new, MobCategory.MISC).sized(1.375F, 0.5625F).clientTrackingRange(10).build("chest_boat"));

    public static void registerEntityAttributes(EntityAttributeCreationEvent event) {
        event.put(AncientEntityTypes.FLUFFALO.get(), Fluffalo.createMobAttributes().build());
        event.put(AncientEntityTypes.FESTIVE_SWET.get(), Swet.createMobAttributes().build());
        event.put(AncientEntityTypes.SLAMMROOT.get(), Slammroot.createMobAttributes().build());
        event.put(AncientEntityTypes.AERONAUTIC_LEAPER.get(), AeronauticLeaper.createMobAttributes().build());
        event.put(AncientEntityTypes.MUTATED_AECHOR_PLANT.get(), MutatedAechorPlant.createMobAttributes().build());
    }

    public static void registerSpawnPlacements(SpawnPlacementRegisterEvent event) {
        event.register(AncientEntityTypes.FLUFFALO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, WyndcapsAnimal::checkWyndcapsAnimalSpawnRules, SpawnPlacementRegisterEvent.Operation.OR);
        event.register(AncientEntityTypes.FESTIVE_SWET.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Swet::checkSwetSpawnRules, SpawnPlacementRegisterEvent.Operation.OR);
        event.register(AncientEntityTypes.SLAMMROOT.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Slammroot::checkSlammrootSpawnRules, SpawnPlacementRegisterEvent.Operation.OR);
    }
}