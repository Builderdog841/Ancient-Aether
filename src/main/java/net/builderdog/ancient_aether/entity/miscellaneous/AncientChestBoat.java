...
public class AncientChestBoat extends AncientBoat implements HasCustomInventoryScreen, ContainerEntity {
    ...
    public AncientChestBoat(EntityType<? extends Boat> entityType, Level level) {
        super(entityType, level);
    }

    public AncientChestBoat(Level level, double x, double y, double z) {
        this(AncientEntityTypes.CHEST_BOAT.get(), level);
        setPos(x, y, z);
        xo = x;
        yo = y;
        zo = z;
