...
public abstract class AbstractVeloxWhirlwind extends Mob {
    public static final EntityDataAccessor<Integer> DATA_COLOR_ID = SynchedEntityData.defineId(AbstractVeloxWhirlwind.class, EntityDataSerializers.INT);
    ...
    public AbstractVeloxWhirlwind(EntityType<? extends AbstractVeloxWhirlwind> type, Level level) {
        super(type, level);
    }
    ...
    public static boolean checkWhirlwindSpawnRules(EntityType<? extends AbstractVeloxWhirlwind> whirlwind, LevelAccessor level, MobSpawnType reason, BlockPos pos, RandomSource random) {
    ...
    public void aiStep() {
        ...
        for (Entity entity : entityList) {
            ...
            if (distance <= 1.5 + d1) {
                ...
                if (entity instanceof AbstractVeloxWhirlwind) {
                    entity.discard();
                }
            } else {
    ...
    protected static class MoveGoal extends Goal {
        private final AbstractVeloxWhirlwind whirlwind;
        protected float movementAngle;
        protected float movementCurve;

        public MoveGoal(AbstractVeloxWhirlwind entity) {
