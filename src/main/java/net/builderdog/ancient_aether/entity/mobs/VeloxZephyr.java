...
public class VeloxZephyr extends FlyingMob implements Enemy {
    public static final EntityDataAccessor<Integer> DATA_ATTACK_CHARGE_ID = SynchedEntityData.defineId(VeloxZephyr.class, EntityDataSerializers.INT);
    public int scale;
    public int scaleAdd;
    public float tailRot;
    public float tailRotAdd;

    public VeloxZephyr(EntityType<? extends VeloxZephyr> type, Level level) {
        super(type, level);
        this.moveControl = new VeloxZephyr.MoveHelperController(this);
        this.xpReward = 5;
    }
    ...
    public static boolean checkVeloxZephyrSpawnRules(EntityType<? extends VeloxZephyr> veloxzephyr, LevelAccessor level, MobSpawnType reason, BlockPos pos, RandomSource random) {
        return level.getDifficulty() != Difficulty.PEACEFUL && Mob.checkMobSpawnRules(veloxzephyr, level, reason, pos, random) && (reason != MobSpawnType.NATURAL || random.nextInt(11) == 0) && level.canSeeSky(pos);
    }
    ...
    protected static class SnowballAttackGoal extends Goal {
        private final VeloxZephyr parentEntity;
        public int attackTimer;

        public SnowballAttackGoal(VeloxZephyr veloxzephyr) {
    ...
    protected static class RandomFlyGoal extends Goal {
        ...
        public RandomFlyGoal(VeloxZephyr entity) {
    ...
    protected static class MoveHelperController extends MoveControl {
        ...
        public MoveHelperController(VeloxZephyr veloxzephyr) {
            super(veloxzephyr);
            this.parentEntity = veloxzephyr;
        }
    ...
    protected static class LookAroundGoal extends Goal {
        ...
        public LookAroundGoal(VeloxZephyr veloxzephyr) {
            this.parentEntity = veloxzephyr;
