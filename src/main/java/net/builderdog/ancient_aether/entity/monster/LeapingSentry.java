...
public class LeapingSentry extends Slime {
	...
	protected void registerGoals() {
		this.goalSelector.addGoal(1, new LeapingSentry.FloatGoal(this));
		this.goalSelector.addGoal(2, new LeapingSentry.AttackGoal(this));
		this.goalSelector.addGoal(3, new LeapingSentry.RandomDirectionGoal(this));
		this.goalSelector.addGoal(5, new LeapingSentry.KeepOnJumpingGoal(this));
	...
	protected ParticleOptions getParticleType() {
		return new BlockParticleOption(ParticleTypes.BLOCK, AncientAetherBlocks.AEROTIC_STONE.get().defaultBlockState());
	}
	...
	@Nonnull
	@Override
	public EntityType<? extends LeapingSentry> getType() {
		return (EntityType<? extends LeapingSentry>) super.getType();
	}
	...
	public static class AttackGoal extends SlimeAttackGoal {
		private final LeapingSentry sentry;

		public AttackGoal(LeapingSentry sentryIn) {
			super(sentryIn);
	...
	public static class FloatGoal extends SlimeFloatGoal {
		...
		public FloatGoal(LeapingSentry sentryIn) {
			super(sentryIn);
			this.sentry = sentryIn;
		}
	...
	public static class KeepOnJumpingGoal extends SlimeKeepOnJumpingGoal {
		...
		public KeepOnJumpingGoal(LeapingSentry sentryIn) {
			super(sentryIn);
			this.sentry = sentryIn;
		}
	...
	public static class RandomDirectionGoal extends SlimeRandomDirectionGoal {
		...
		public RandomDirectionGoal(LeapingSentry sentryIn) {
			super(sentryIn);
			this.sentry = sentryIn;
		}
