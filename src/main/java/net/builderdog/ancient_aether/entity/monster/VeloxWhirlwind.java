...
public class VeloxWhirlwind extends AbstractVeloxWhirlwind {
    public VeloxWhirlwind(EntityType<? extends VeloxWhirlwind> type, Level level) {
        super(type, level);
    }
    ...
    public void updateParticles() {
        for (int i = 0; i < 2; i++) {
            ...
            this.level.addParticle(AncientAetherParticleTypes.VELOX_WHIRLWIND.get(), d1, d4 - 0.25, d7, -Math.sin(0.01745329F * f) * 0.75, 0.125, Math.cos(0.01745329F * f) * 0.75);
        }
    }
