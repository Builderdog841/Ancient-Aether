...
public class AncientAetherCreativeModeTabs {
    ...
    public static void buildCreativeModeTabs(BuildCreativeModeTabContentsEvent event) {
        ...
        if (tab == AetherCreativeTabs.AETHER_DUNGEON_BLOCKS.get()) {
            ...
            event.getEntries().putAfter(new ItemStack(AncientAetherBlocks.TREASURE_DOORWAY_LIGHT_AEROGETIC_STONE.get()), new ItemStack(AncientAetherBlocks.CORRUPTED_AEROGETIC_STONE.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().putAfter(new ItemStack(AncientAetherBlocks.CORRUPTED_AEROGETIC_STONE.get()), new ItemStack(AncientAetherBlocks.LOCKED_CORRUPTED_AEROGETIC_STONE.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().putAfter(new ItemStack(AncientAetherBlocks.LOCKED_CORRUPTED_AEROGETIC_STONE.get()), new ItemStack(AncientAetherBlocks.TRAPPED_CORRUPTED_AEROGETIC_STONE.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().putAfter(new ItemStack(AncientAetherBlocks.TRAPPED_CORRUPTED_AEROGETIC_STONE.get()), new ItemStack(AncientAetherBlocks.BOSS_DOORWAY_CORRUPTED_AEROGETIC_STONE.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().putAfter(new ItemStack(AncientAetherBlocks.BOSS_DOORWAY_CORRUPTED_AEROGETIC_STONE.get()), new ItemStack(AncientAetherBlocks.TREASURE_DOORWAY_CORRUPTED_AEROGETIC_STONE.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
