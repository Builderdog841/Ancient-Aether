...
public class AncientAetherCreativeModeTabs {
    ...
    public static void buildCreativeModeTabs(BuildCreativeModeTabContentsEvent event) {
        ...
        if (tab == AetherCreativeTabs.AETHER_DUNGEON_BLOCKS.get()) {
            ...
            event.getEntries().putAfter(new ItemStack(AncientAetherBlocks.CARVED_TILES.get()), new ItemStack(AncientAetherBlocks.CARVED_TILE_STAIRS.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            ...
            event.getEntries().putAfter(new ItemStack(AncientAetherBlocks.ANCIENT_MOSSY_HOLYSTONE_VASE.get()), new ItemStack(AncientAetherBlocks.ANCIENT_FROSTED_HOLYSTONE_VASE.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().putAfter(new ItemStack(AncientAetherBlocks.ANCIENT_FROSTED_HOLYSTONE_VASE.get()), new ItemStack(AncientAetherBlocks.ANCIENT_SENTRY_VASE.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
        ...
        if (tab == AetherCreativeTabs.AETHER_FUNCTIONAL_BLOCKS.get()) {
            ...
            event.getEntries().putAfter(new ItemStack(AncientAetherBlocks.MOSSY_HOLYSTONE_VASE.get()), new ItemStack(AncientAetherBlocks.FROSTED_HOLYSTONE_VASE.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().putAfter(new ItemStack(AncientAetherBlocks.FROSTED_HOLYSTONE_VASE.get()), new ItemStack(AncientAetherBlocks.SENTRY_VASE.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            ...
            event.getEntries().putAfter(new ItemStack(AncientAetherBlocks.UNPOWERED_ANCIENT_OBELISK.get()), new ItemStack(AncientAetherBlocks.UNPOWERED_ANCIENT_OBELISK.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
