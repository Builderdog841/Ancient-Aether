...
public class AncientAetherCreativeModeTabs {
    ...
    public static void buildCreativeModeTabs(BuildCreativeModeTabContentsEvent event) {
        ...
        if (tab == AetherCreativeTabs.AETHER_DUNGEON_BLOCKS.get()) {
            ...
            event.getEntries().putAfter(new ItemStack(AetherBlocks.ANGELIC_WALL.get()), new ItemStack(AncientAetherBlocks.ANGELIC_CORNER_BRICK.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().putAfter(new ItemStack(AncientAetherBlocks.ANGELIC_CORNER_BRICK.get()), new ItemStack(AncientAetherBlocks.ANGELIC_STONE_MOSAIC.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            ...
            event.getEntries().putAfter(new ItemStack(AetherBlocks.TREASURE_DOORWAY_LIGHT_ANGELIC_STONE.get()), new ItemStack(AncientAetherBlocks.VALKYRIE_BRICKS.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().putAfter(new ItemStack(AncientAetherBlocks.VALKYRIE_BRICKS.get()), new ItemStack(AncientAetherBlocks.VALKYRIE_BRICK_STAIRS.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().putAfter(new ItemStack(AncientAetherBlocks.VALKYRIE_BRICK_STAIRS.get()), new ItemStack(AncientAetherBlocks.VALKYRIE_BRICK_SLAB.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().putAfter(new ItemStack(AncientAetherBlocks.VALKYRIE_BRICK_SLAB.get()), new ItemStack(AncientAetherBlocks.VALKYRIE_BRICK_WALL.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().putAfter(new ItemStack(AncientAetherBlocks.VALKYRIE_BRICK_WALL.get()), new ItemStack(AncientAetherBlocks.VALKYRIE_TILES.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().putAfter(new ItemStack(AncientAetherBlocks.VALKYRIE_TILES.get()), new ItemStack(AncientAetherBlocks.VALKYRIE_TILE_STAIRS.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().putAfter(new ItemStack(AncientAetherBlocks.VALKYRIE_TILE_STAIRS.get()), new ItemStack(AncientAetherBlocks.VALKYRIE_TILE_SLAB.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().putAfter(new ItemStack(AncientAetherBlocks.VALKYRIE_TILE_SLAB.get()), new ItemStack(AncientAetherBlocks.VALKYRIE_TILE_WALL.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
        ...
        if (tab == AetherCreativeTabs.AETHER_FUNCTIONAL_BLOCKS.get()) {
            ...
            event.getEntries().putAfter(new ItemStack(AncientAetherBlocks.HIGHSPROOT_SIGN.get()), new ItemStack(AncientAetherBlocks.HIGHSPROOT_HANGING_SIGN.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().putAfter(new ItemStack(AncientAetherBlocks.HIGHSPROOT_HANGING_SIGN.get()), new ItemStack(AncientAetherBlocks.SAKURA_SIGN.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().putAfter(new ItemStack(AncientAetherBlocks.SAKURA_SIGN.get()), new ItemStack(AncientAetherBlocks.SAKURA_HANGING_SIGN.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
        ...
        if (tab == AetherCreativeTabs.AETHER_ARMOR_AND_ACCESSORIES.get()) {
            ...
            event.getEntries().putAfter(new ItemStack(AncientAetherItems.HERMES_RING.get()), new ItemStack(AncientAetherItems.WARRIOR_RING.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().putAfter(new ItemStack(AncientAetherItems.WARRIOR_RING.get()), new ItemStack(AncientAetherItems.GROWTH_RING.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().putAfter(new ItemStack(AncientAetherItems.GROWTH_RING.get()), new ItemStack(AncientAetherItems.ANCIENT_RING.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            ...
            event.getEntries().putAfter(new ItemStack(AncientAetherItems.HERMES_PENDANT.get()), new ItemStack(AncientAetherItems.WARRIOR_PENDANT.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().putAfter(new ItemStack(AncientAetherItems.WARRIOR_PENDANT.get()), new ItemStack(AncientAetherItems.GROWTH_PENDANT.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().putAfter(new ItemStack(AncientAetherItems.GROWTH_PENDANT.get()), new ItemStack(AncientAetherItems.ANCIENT_PENDANT.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
        ...
        if (tab == AetherCreativeTabs.AETHER_FOOD_AND_DRINKS.get()) {
            ...
            event.getEntries().putAfter(new ItemStack(AncientAetherItems.GRAPES.get()), new ItemStack(AncientAetherItems.SLAMMBERRY.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
        ...
        if (tab == AetherCreativeTabs.AETHER_SPAWN_EGGS.get()) {
            ...
            event.getEntries().putBefore(new ItemStack(AetherItems.SHEEPUFF_SPAWN_EGG.get()), new ItemStack(AncientAetherItems.SLAMMROOT_SPAWN_EGG.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
