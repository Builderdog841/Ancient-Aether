...
public class AncientAetherItems {
    ...
    public static final RegistryObject<Item> SLAMMROOT_FRUIT = ITEMS.register("slammroot_fruit", () -> new SlammrootFruitItem(new Item.Properties().food((new FoodProperties.Builder()).alwaysEat().effect(() -> new MobEffectInstance(AncientAetherEffects.NATURE_BOOST.get(), 60, 0), 1.0F).build())));
