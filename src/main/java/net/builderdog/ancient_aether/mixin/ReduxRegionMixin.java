...
public abstract class ReduxRegionMixin extends Region {

    public ReduxRegionMixin(ResourceLocation name, RegionType type, int weight) {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        ...
        addBiome(mapper, new Climate.ParameterPoint(tempWyndcaps, fullRange, fullRange, erosionDefault, Climate.Parameter.span(0.05F, 1.5F), fullRange, 0),
