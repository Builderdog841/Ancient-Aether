...
public class DARegionMixin extends Region {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        ...
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot, Climate.Parameter.span(-1.5F, -0.25F), continentDefault, erosionDefault, depthSurface, forestDistGolden, 0),
                DABiomes.GOLDEN_HEIGHTS);
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot, Climate.Parameter.span(-0.25F, 0.25F), continentDefault, erosionDefault, depthSurface, forestDistGolden, 0),
                DABiomes.GOLDEN_GROVE);
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot, Climate.Parameter.span(0.25F, 1.5F), continentDefault, erosionDefault, depthSurface, forestDistGolden, 0),
                DABiomes.GOLDEN_HEIGHTS);
