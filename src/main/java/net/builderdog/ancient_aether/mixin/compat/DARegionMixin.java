...
public class DARegionMixin extends Region {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        ...
        addBiome(mapper, new Climate.ParameterPoint(tempWyndcaps, Climate.Parameter.span(0.25F, 1.5F), fullRange, erosionDefault, depthWyndcaps, fullRange, 0), AncientAetherBiomes.FESTIVE_WYNDCAP_TAIGA);
        ...
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot1, Climate.Parameter.span(-0.1F, 0.1F), fullRange, erosionDefault, depthSurface, fullRange, 0), DABiomes.AERLAVENDER_FIELDS);
        ...
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot1, Climate.Parameter.span(0.1F, 1.5F), fullRange, erosionSunForest, depthSurface, fullRange, 0), DABiomes.GOLDEN_GROVE);
        ...
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot2, Climate.Parameter.span(-1.5F, -0.1F), fullRange, erosionSunForest, depthSurface, fullRange, 0), DABiomes.GOLDEN_HEIGHTS);
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot2, Climate.Parameter.span(-0.1F, 0.25F), fullRange, erosionDefault, depthSurface, fullRange, 0), AetherBiomes.SKYROOT_GROVE);
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot2, Climate.Parameter.span(0.25F, 1.5F), fullRange, erosionDefault, depthSurface, fullRange, 0), DABiomes.AERLAVENDER_FIELDS);

        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot3, Climate.Parameter.span(-1.5F, -0.25F), fullRange, erosionDefault, depthSurface, fullRange, 0), DABiomes.AERLAVENDER_FIELDS);
        ...
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot3, Climate.Parameter.span(-0.05F, 0.2F), fullRange, erosionSunForest, depthSurface, fullRange, 0), DABiomes.GOLDEN_GROVE);
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot3, Climate.Parameter.span(0.2F, 1.5F), fullRange, erosionDefault, depthSurface, fullRange, 0), AetherBiomes.SKYROOT_GROVE);

        addBiome(mapper, new Climate.ParameterPoint(tempSakura, fullRange, fullRange, erosionDefault, fullRange, fullRange, 0), DABiomes.YAGROOT_SWAMP);

        addBiome(mapper, new Climate.ParameterPoint(fullRange, Climate.Parameter.span(-1.5F, -0.2F), fullRange, erosionElevated, depthElevated, fullRange, 0), DABiomes.BLUE_AERGLOW_FOREST);
        addBiome(mapper, new Climate.ParameterPoint(fullRange, Climate.Parameter.span(-0.2F, 0.2F), fullRange, erosionElevated, depthElevated, fullRange, 0), DABiomes.MYSTIC_AERGLOW_FOREST);
        addBiome(mapper, new Climate.ParameterPoint(fullRange, Climate.Parameter.span(0.2F, 1.5F), fullRange, erosionElevated, depthElevated, fullRange, 0), DABiomes.AERGLOW_FOREST);

        if (AncientAetherConfig.COMMON.experimental_features.get()) {
            Climate.Parameter tempAtmosine = Climate.Parameter.span(-1.5F, 0.5F);

            addBiome(mapper, new Climate.ParameterPoint(Climate.Parameter.span(-0.5F, 0.5F), Climate.Parameter.span(-1.5F, 0.15F), fullRange, erosionDefault, depthUnderground, fullRange, 0), AncientAetherBiomes.HOLYSTONE_CAVERNS);
