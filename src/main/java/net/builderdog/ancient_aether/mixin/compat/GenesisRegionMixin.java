...
public class GenesisRegionMixin extends Region {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        ...
        //Skyroot Forests
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot, Climate.Parameter.span(-1.5F, -0.2F), fullRange, erosionDefault, depthSurface, forestDistWooded1, 0),
                GenesisBiomes.VIBRANT_WOODLAND);
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot, Climate.Parameter.span(-0.2F, 0.0F), fullRange, erosionDefault, depthSurface, forestDistWooded1, 0),
                GenesisBiomes.VIBRANT_MEADOW);
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot, Climate.Parameter.span(0.0F, 1.5F), fullRange, erosionDefault, depthSurface, forestDistWooded1, 0),
                GenesisBiomes.VIBRANT_FOREST);

        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot, Climate.Parameter.span(-1.5F, -0.5F), fullRange, erosionDefault, depthSurface, forestDistBarren, 0),
                GenesisBiomes.VIBRANT_MEADOW);
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot, Climate.Parameter.span(-0.5F, -0.1F), fullRange, erosionDefault, depthSurface, forestDistBarren, 0),
                GenesisBiomes.VIBRANT_GROVE);
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot, Climate.Parameter.span(-0.1F,  0.3F), fullRange, erosionDefault, depthSurface, forestDistBarren, 0),
                GenesisBiomes.VIBRANT_MEADOW);
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot, Climate.Parameter.span(0.3F,  1.5F), fullRange, erosionDefault, depthSurface, forestDistBarren, 0),
                GenesisBiomes.VIBRANT_FOREST);

        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot, Climate.Parameter.span(-1.5F,  0.0F), fullRange, erosionDefault, depthSurface, forestDistWooded2, 0),
                GenesisBiomes.VIBRANT_FOREST);
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot, Climate.Parameter.span(0.0F,  1.5F), fullRange, erosionDefault, depthSurface, forestDistWooded2, 0),
                GenesisBiomes.VIBRANT_WOODLAND);
