...
public class ReduxRegionMixin extends Region {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        ...
        addBiome(mapper, new Climate.ParameterPoint(tempSakura, Climate.Parameter.span(-0.35F, 1.5F), fullRange, erosionDefault, fullRange, fullRange, 0), ReduxBiomes.THE_BLIGHT);
