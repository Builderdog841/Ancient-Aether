...
public class ReduxRegionMixin extends Region {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        ...
        Climate.Parameter continentDefault = Climate.Parameter.span(-1.5F, 0.23F);
        ...
        //Wyndcaps
        addBiome(mapper, new Climate.ParameterPoint(tempWyndcaps, Climate.Parameter.span(-1.5F, -0.2F), continentDefault, erosionDefault, Climate.Parameter.span(0.05F, 0.55F), fullRange, 0),
                ReduxBiomes.FROSTED_FORESTS);
        addBiome(mapper, new Climate.ParameterPoint(tempWyndcaps, Climate.Parameter.span(-0.2F, 0.5F), continentDefault, erosionDefault, Climate.Parameter.span(0.05F, 0.55F), fullRange, 0),
                ReduxBiomes.GLACIAL_TUNDRA);
        addBiome(mapper, new Climate.ParameterPoint(tempWyndcaps, Climate.Parameter.span(0.5F, 1.5F), continentDefault, erosionDefault, Climate.Parameter.span(0.05F, 0.55F), fullRange, 0),
                ReduxBiomes.CLOUDCAPS);
        addBiome(mapper, new Climate.ParameterPoint(tempWyndcaps, Climate.Parameter.span(-1.5F, -0.2F), continentDefault, erosionDefault, Climate.Parameter.span(-0.15F, 0.05F), fullRange, 0),
                ReduxBiomes.FROSTED_FORESTS);
        addBiome(mapper, new Climate.ParameterPoint(tempWyndcaps, Climate.Parameter.span(-0.2F, 1.5F), continentDefault, erosionDefault, Climate.Parameter.span(-0.15F, 0.05F), fullRange, 0),
                ReduxBiomes.GLACIAL_TUNDRA);
        ...
        //Skyroot Forests
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot, fullRange, continentDefault, erosionDefault, depthSurface, forestDistCrystal1, 0),
                ReduxBiomes.SKYFIELDS);
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot, Climate.Parameter.span(-1.5F, -0.25F), continentDefault, erosionDefault, depthSurface, forestDistCrystal2, 0),
                AetherBiomes.SKYROOT_MEADOW);
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot, Climate.Parameter.span(-0.25F, 1.5F), continentDefault, erosionDefault, depthSurface, forestDistCrystal2, 0),
                ReduxBiomes.SKYFIELDS);
        ...
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot, Climate.Parameter.span(-1.5F, -0.3F), continentDefault, erosionDefault, depthSurface, forestDistGolden, 0),
                ReduxBiomes.GILDED_GRASSLANDS);
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot, Climate.Parameter.span(-0.3F, 0.3F), continentDefault, erosionDefault, depthSurface, forestDistGolden, 0),
                ReduxBiomes.GILDED_GROVES);
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot, Climate.Parameter.span(0.3F, 1.5F), continentDefault, erosionDefault, depthSurface, forestDistGolden, 0),
                ReduxBiomes.GILDED_GRASSLANDS);
