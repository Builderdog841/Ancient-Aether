...
public class ReduxRegionMixin extends Region {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        ...
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot1, Climate.Parameter.span(-0.1F, 0.1F), fullRange, erosionDefault, depthSurface, noRidges, 0), ReduxBiomes.SKYROOT_SHRUBLANDS);
        ...
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot1, Climate.Parameter.span(0.1F, 1.5F), fullRange, erosionSunForest, depthSurface, noRidges, 0), ReduxBiomes.GILDED_GROVES);
        ...
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot2, Climate.Parameter.span(-1.5F, -0.1F), fullRange, erosionSunForest, depthSurface, noRidges, 0), ReduxBiomes.GILDED_GRASSLANDS);
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot2, Climate.Parameter.span(-0.1F, 0.25F), fullRange, erosionDefault, depthSurface, noRidges, 0), ReduxBiomes.SKYFIELDS);
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot2, Climate.Parameter.span(0.25F, 1.5F), fullRange, erosionDefault, depthSurface, noRidges, 0), ReduxBiomes.SKYROOT_SHRUBLANDS);

        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot3, Climate.Parameter.span(-1.5F, -0.25F), fullRange, erosionDefault, depthSurface, noRidges, 0), ReduxBiomes.SKYROOT_SHRUBLANDS);
        ...
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot3, Climate.Parameter.span(-0.05F, 0.2F), fullRange, erosionSunForest, depthSurface, noRidges, 0), ReduxBiomes.GILDED_GROVES);
        addBiome(mapper, new Climate.ParameterPoint(tempSkyroot3, Climate.Parameter.span(0.2F, 1.5F), fullRange, erosionDefault, depthSurface, noRidges, 0), ReduxBiomes.SKYFIELDS);
        ...
        addBiome(mapper, new Climate.ParameterPoint(tempSakura, Climate.Parameter.span(-1.5F, -0.5F), fullRange, erosionDefault, fullRange, fullRange, 0), ReduxBiomes.THE_BLIGHT);
        ...
        addBiome(mapper, new Climate.ParameterPoint(tempSakura, Climate.Parameter.span(0.5F, 1.5F), fullRange, erosionDefault, fullRange, fullRange, 0), ReduxBiomes.THE_BLIGHT);
