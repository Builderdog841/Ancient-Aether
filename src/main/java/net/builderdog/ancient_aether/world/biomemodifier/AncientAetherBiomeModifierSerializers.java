    ...
    static {
       ...
       CARVER_CODEC = BIOME_MODIFIER_SERIALIZERS.register("add_carver", () -> {
           return RecordCodecBuilder.create((builder) -> {
               return builder.group(Biome.f_47432_.fieldOf("biomes").forGetter(CarverModifier::biomes), ConfiguredWorldCarver.f_64847_.fieldOf("carver").forGetter(CarverModifier::carver)).apply(builder, CarverModifier::new);
            });
        });
    }
}
