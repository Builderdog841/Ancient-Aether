...
public class AncientAetherRegion extends Region {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        ...
        addBiome(mapper, new Climate.ParameterPoint(Climate.Parameter.span(0.15F, 0.45F), Climate.Parameter.span(-0.6F, -0.4F), fullRange, fullRange, Climate.Parameter.span(0.0F, 0.6F), fullRange, 0),
                AetherBiomes.SKYROOT_GROVE);
        addBiome(mapper, new Climate.ParameterPoint(Climate.Parameter.span(0.15F, 0.45F), Climate.Parameter.span(-0.4F, 0.0F), fullRange, fullRange, fullRange, fullRange, 0),
        ...
        addBiome(mapper, new Climate.ParameterPoint(Climate.Parameter.span(0.15F, 0.45F), Climate.Parameter.span(0.2F, 0.75F), fullRange, fullRange, fullRange, fullRange, 0),
                AetherBiomes.SKYROOT_FOREST);
        addBiome(mapper, new Climate.ParameterPoint(Climate.Parameter.span(0.15F, 0.45F), Climate.Parameter.span(0.75F, 1.0F), fullRange, fullRange, Climate.Parameter.span(0.0F, 0.6F), fullRange, 0),
                AncientAetherBiomes.SKYROOT_PINE_FOREST);
        ...
        addBiome(mapper, new Climate.ParameterPoint(Climate.Parameter.span(-0.35F, -0.25F), Climate.Parameter.span(0F, 1F), fullRange, fullRange, Climate.Parameter.span(0.0F, 0.6F), fullRange, 0),
                AetherBiomes.SKYROOT_FOREST);
        ...
        addBiome(mapper, new Climate.ParameterPoint(Climate.Parameter.span(-0.6F, -0.45F), fullRange, fullRange, fullRange, Climate.Parameter.span(-0.6F, 1.0F), fullRange, 0),
                AncientAetherBiomes.WYNDCAP_TAIGA);
        addBiome(mapper, new Climate.ParameterPoint(Climate.Parameter.span(-0.75F, -0.6F), fullRange, fullRange, fullRange, Climate.Parameter.span(-0.6F, 1.0F), fullRange, 0),
                AncientAetherBiomes.FESTIVE_WYNDCAP_TAIGA);
        addBiome(mapper, new Climate.ParameterPoint(Climate.Parameter.span(-1F, -0.75F), fullRange, fullRange, fullRange, Climate.Parameter.span(-0.6F, 1.0F), fullRange, 0),
                AncientAetherBiomes.WYNDCAP_TAIGA);

        addBiome(mapper, new Climate.ParameterPoint(Climate.Parameter.span(-0.55F, -0.45F), fullRange, fullRange, fullRange, Climate.Parameter.span(-0.9F, -0.6F), fullRange, 0),
                AncientAetherBiomes.WYNDCAP_TAIGA);
        addBiome(mapper, new Climate.ParameterPoint(Climate.Parameter.span(-1.F, -0.55F), fullRange, fullRange, fullRange, Climate.Parameter.span(-0.9F, -0.6F), fullRange, 0),
                AncientAetherBiomes.WYNDCAP_HIGHLAND);

        addBiome(mapper, new Climate.ParameterPoint(Climate.Parameter.span(-0.55F, -0.45F), fullRange, fullRange, fullRange, Climate.Parameter.span(-1.5F, -0.9F), fullRange, 0),
                AncientAetherBiomes.WYNDCAP_HIGHLAND);
