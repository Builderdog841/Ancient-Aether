...
public class AncientAetherRegion extends Region {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        ...
        //SAKURA JUNGLE
        Climate.Parameter temps1 = Climate.Parameter.span(-1F, -0.35F);

        //QUICKSOIL DESERT
        Climate.Parameter temps2 = Climate.Parameter.span(0.1F, 0.7F);

        //HIGHLANDS TAIGA
        Climate.Parameter temps3 = Climate.Parameter.span(-0.35F, -0.2F);

        this.addBiome(mapper, new Climate.ParameterPoint(temps1, Climate.Parameter.span(-1F, -0.35F), fullRange, fullRange, fullRange, fullRange, 0),
        ...
        this.addBiome(mapper, new Climate.ParameterPoint(temps3, Climate.Parameter.span(-0.35F, -0.2F), fullRange, fullRange, fullRange, fullRange, 0),
