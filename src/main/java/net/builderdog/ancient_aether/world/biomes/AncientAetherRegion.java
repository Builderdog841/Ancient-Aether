...
public class AncientAetherRegion extends Region {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        ...
        addBiome(mapper, new Climate.ParameterPoint(Climate.Parameter.span(0.15F, 0.45F), Climate.Parameter.span(-0.4F, 0.0F), fullRange, fullRange, Climate.Parameter.span(-1.5F, 0.2F), fullRange, 0),
        ...
        addBiome(mapper, new Climate.ParameterPoint(Climate.Parameter.span(-0.35F, -0.25F), Climate.Parameter.span(-0.3F, 0F), fullRange, fullRange, fullRange, fullRange, 0),
                AncientAetherBiomes.SKYROOT_PINE_FOREST);
        addBiome(mapper, new Climate.ParameterPoint(Climate.Parameter.span(-0.35F, -0.25F), Climate.Parameter.span(-0.55F, -0.3F), fullRange, fullRange, Climate.Parameter.span(-1.5F, 0.2F), fullRange, 0),
                AetherBiomes.SKYROOT_MEADOW);
        ...
        addBiome(mapper, new Climate.ParameterPoint(Climate.Parameter.span(-1F, -0.55F), fullRange, fullRange, fullRange, Climate.Parameter.span(-1.5F, -1F), fullRange, 0),
                AncientAetherBiomes.WYNDCAP_PEAKS);

        addBiome(mapper, new Climate.ParameterPoint(fullRange, Climate.Parameter.span(-0.25F, 0.15F), Climate.Parameter.span(-0.6F, 0.3F), fullRange, Climate.Parameter.span(0.2F, 1.5F), fullRange, 0),
                AncientAetherBiomes.CRYSTAL_HOLLOWS);

        addBiome(mapper, new Climate.ParameterPoint(fullRange, Climate.Parameter.span(0.15F, 0.45F), Climate.Parameter.span(-0.4F, 0.0F), fullRange, Climate.Parameter.span(0.2F, 1.5F), fullRange, 0),
                AncientAetherBiomes.CRYSTAL_HOLLOWS);
    }
}