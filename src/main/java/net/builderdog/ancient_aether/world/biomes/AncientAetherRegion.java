...
public class AncientAetherRegion extends Region {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        ...
        Climate.Parameter tempDefault3 = Climate.Parameter.span(0.3F, 0.4F);
        ...
        Climate.Parameter tempDefault7 = Climate.Parameter.span(-0.5F, -0.3F);
        ...
        Climate.Parameter tempSakura6 = Climate.Parameter.span(-0.2F, 0.2F); //Overgrown Caverns

        Climate.Parameter tempHighland1 = Climate.Parameter.span(-0.9F, -0.5F); //Highland Clearing
        Climate.Parameter tempHighland2 = Climate.Parameter.span(-0.8F, -0.6F); //Icestone Caverns
        ...
        this.addBiome(mapper, new Climate.ParameterPoint(tempDefault5, Climate.Parameter.span(-0.6F, -0.3F), fullRange, fullRange, fullRange, fullRange, 0),
                AetherBiomes.SKYROOT_GROVE);
        this.addBiome(mapper, new Climate.ParameterPoint(tempDefault7, Climate.Parameter.span(-1F, -0.6F), fullRange, fullRange, fullRange, fullRange, 0),
                AetherBiomes.SKYROOT_GROVE);
        ...
        this.addBiome(mapper, new Climate.ParameterPoint(tempSakura1, Climate.Parameter.span(-1.0F, -0.5F), fullRange, fullRange, Climate.Parameter.span(-1F, 0.65F), fullRange, 0),
                AncientAetherBiomes.SPARSE_SAKURA_JUNGLE);
        this.addBiome(mapper, new Climate.ParameterPoint(tempSakura2, Climate.Parameter.span(-1.0F, -0.5F), fullRange, fullRange, Climate.Parameter.span(-1F, 0.65F), fullRange, 0),
                AncientAetherBiomes.SAKURA_JUNGLE);
        this.addBiome(mapper, new Climate.ParameterPoint(tempSakura3, Climate.Parameter.span(-1.0F, -0.5F), fullRange, fullRange, Climate.Parameter.span(-1F, 0.65F), fullRange, 0),
                AncientAetherBiomes.DEEP_SAKURA_JUNGLE);
        this.addBiome(mapper, new Climate.ParameterPoint(tempSakura4, Climate.Parameter.span(-1.0F, -0.5F), fullRange, fullRange, Climate.Parameter.span(-1F, 0.65F), fullRange, 0),
                AncientAetherBiomes.SAKURA_JUNGLE);
        this.addBiome(mapper, new Climate.ParameterPoint(tempSakura5, Climate.Parameter.span(-1.0F, -0.5F), fullRange, fullRange, Climate.Parameter.span(-1F, 0.65F), fullRange, 0),
                AncientAetherBiomes.SPARSE_SAKURA_JUNGLE);
        this.addBiome(mapper, new Climate.ParameterPoint(tempSakura6, Climate.Parameter.span(-1.0F, -0.5F), fullRange, fullRange, Climate.Parameter.span(0.65F, 1F), fullRange, 0),
        ...
        this.addBiome(mapper, new Climate.ParameterPoint(tempHighland1, Climate.Parameter.span(-0.5F, -0.35F), fullRange, fullRange, Climate.Parameter.span(0F, 0.65F), fullRange, 0),
                AncientAetherBiomes.FESTIVE_HIGHLAND_TAIGA);
        this.addBiome(mapper, new Climate.ParameterPoint(tempHighland1, Climate.Parameter.span(-0.35F, 1F), fullRange, fullRange, Climate.Parameter.span(0F, 0.65F), fullRange, 0),
                AncientAetherBiomes.HIGHLAND_TAIGA);
        this.addBiome(mapper, new Climate.ParameterPoint(tempHighland2, Climate.Parameter.span(-0.5F, 1F), fullRange, fullRange, Climate.Parameter.span(0.65F, 1F), fullRange, 0),
