...
public class AncientAetherRegion extends Region {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        ...
        addBiome(mapper, new Climate.ParameterPoint(Climate.Parameter.span(0.15F, 0.45F), Climate.Parameter.span(-0.4F, 0.0F), fullRange, Climate.Parameter.span(-1.5F, 0.3F), fullRange, fullRange, 0),
        ...
        addBiome(mapper, new Climate.ParameterPoint(Climate.Parameter.span(-0.35F, -0.25F), Climate.Parameter.span(-0.3F, 0F), fullRange, fullRange, fullRange, fullRange, 0),
                AncientAetherBiomes.SKYROOT_PINE_FOREST);
        addBiome(mapper, new Climate.ParameterPoint(Climate.Parameter.span(-0.35F, -0.25F), Climate.Parameter.span(-0.55F, -0.3F), fullRange, Climate.Parameter.span(-1.5F, 0.3F), fullRange, fullRange, 0),
                AetherBiomes.SKYROOT_MEADOW);
        ...
        addBiome(mapper, new Climate.ParameterPoint(Climate.Parameter.span(-0.45F, -0.35F), fullRange, fullRange, Climate.Parameter.span(-0.65F, 1.0F), fullRange, fullRange, 0),
        ...
        addBiome(mapper, new Climate.ParameterPoint(Climate.Parameter.span(-0.55F, -0.45F), fullRange, fullRange, Climate.Parameter.span(-1.5F, -0.7F), fullRange, fullRange, 0),
                AncientAetherBiomes.WYNDCAP_HIGHLAND);

        addBiome(mapper, new Climate.ParameterPoint(Climate.Parameter.span(-1F, -0.55F), fullRange, fullRange, Climate.Parameter.span(-1.5F, -0.7F), fullRange, fullRange, 0),
