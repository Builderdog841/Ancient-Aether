...
public class AncientAetherRegion extends Region {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        ...
        //SAKURA JUNGLE
        Climate.Parameter temps1 = Climate.Parameter.span(0.5F, 0.94F);

        //QUICKSOIL DESERT
        Climate.Parameter temps2 = Climate.Parameter.span(-0.8F, -0.3F);

        //HIGHLANDS TAIGA
        Climate.Parameter temps3 = Climate.Parameter.span(0.2F, 0.5F);

        this.addBiome(mapper, new Climate.ParameterPoint(temps1, Climate.Parameter.span(0F, 0.1F), fullRange, fullRange, fullRange, fullRange, 0),
