...
public class AncientAetherRegion extends Region {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        ...
        addBiome(mapper, new Climate.ParameterPoint(fullRange, Climate.Parameter.span(-1.5F, -0.6F), Climate.Parameter.span(0.375F, 1.5F), fullRange, fullRange, fullRange, 0),
                AetherBiomes.SKYROOT_MEADOW);
        addBiome(mapper, new Climate.ParameterPoint(fullRange, Climate.Parameter.span(-0.6F, 0.6F), Climate.Parameter.span(0.375F, 1.5F), fullRange, fullRange, fullRange, 0),
                AetherBiomes.SKYROOT_GROVE);
        addBiome(mapper, new Climate.ParameterPoint(fullRange, Climate.Parameter.span(0.6F, 1.5F), Climate.Parameter.span(0.375F, 1.5F), fullRange, fullRange, fullRange, 0),
                AetherBiomes.SKYROOT_WOODLAND);

        addBiome(mapper, new Climate.ParameterPoint(fullRange, fullRange, Climate.Parameter.span(0.25F, 0.375F), fullRange, Climate.Parameter.span(-1.5F, 0.4F), fullRange, 0),
                AetherBiomes.SKYROOT_GROVE);
