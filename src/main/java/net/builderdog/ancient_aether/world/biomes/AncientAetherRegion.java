...
public class AncientAetherRegion extends Region {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        ...
        Climate.Parameter tempDefault2 = Climate.Parameter.span(-0.3F, 0.0F);
        ...
        Climate.Parameter tempSakura1 = Climate.Parameter.span(-0.8F, -0.3F);
        ...
        addBiome(mapper, new Climate.ParameterPoint(tempSakura1, Climate.Parameter.span(-1.0F, 0.0F), fullRange, fullRange, Climate.Parameter.span(-1.0F, 0.2F), fullRange, 0),
                AncientAetherBiomes.SPARSE_SAKURA_JUNGLE);
        addBiome(mapper, new Climate.ParameterPoint(tempSakura1, Climate.Parameter.span(-1.0F, 0.0F), fullRange, fullRange, Climate.Parameter.span(0.2F, 1.0F), fullRange, 0),
