...
public class LargeCactusFeature extends AetherCactusFeature {


    public LargeCactusFeature(Codec<LargeCactusConfiguration> codec) {
        super(codec);
    }
    ...
    public boolean place(@NotNull FeaturePlaceContext<LargeCactusConfiguration> context) {
        ...
        i++;
        this.setBlock(level, pos.above(i), AncientAetherBlocks.CACTUS_FLOWER.get().defaultBlockState());
