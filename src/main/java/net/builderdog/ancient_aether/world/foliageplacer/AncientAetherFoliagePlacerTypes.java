...
public class AncientAetherFoliagePlacerTypes {
    ...
    public static final RegistryObject<FoliagePlacerType<HookedCrystalFoliagePlacer>> HOOKED_CRYSTAL_FOLIAGE_PLACER = FOLIAGE_PLACERS.register("hooked_crystal_foliage_placer", () -> new FoliagePlacerType<>(HookedCrystalFoliagePlacer.CODEC));
}