...
public class AncientAetherHookedFoliagePlacer extends FoliagePlacer {

    //This code was written by the Aether Team and not by me
    public static final Codec<AncientAetherHookedFoliagePlacer> CODEC = RecordCodecBuilder.create((codec) -> foliagePlacerParts(codec)
            .and(IntProvider.codec(0, 24).fieldOf("trunk_height").forGetter((placer) -> placer.trunkHeight))
            .apply(codec, AncientAetherHookedFoliagePlacer::new));
    private final IntProvider trunkHeight;

    public AncientAetherHookedFoliagePlacer(IntProvider radius, IntProvider offset, IntProvider height) {
        super(radius, offset);
    ...
    protected FoliagePlacerType<?> type() {
        return AncientAetherFoliagePlacerTypes.ANCIENT_AETHER_HOOKED_FOLIAGE_PLACER.get();
    }
