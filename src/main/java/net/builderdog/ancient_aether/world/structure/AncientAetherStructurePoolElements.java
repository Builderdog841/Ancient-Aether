...
public class AncientAetherStructurePoolElements {
    ...
    public static final RegistryObject<StructurePoolElementType<UndergroundDungeonRoom>> UNDERGROUND_DUNGEON_ENTRANCE = STRUCTURE_POOL_ELEMENT.register("underground_dungeon_entrance", () -> () -> UndergroundDungeonRoom.CODEC);
}