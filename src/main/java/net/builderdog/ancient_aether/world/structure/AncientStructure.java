...
public class AncientStructure extends EndCityStructure {
    ...
    public StructureType<?> type() {
        return AncientAetherStructureTypes.ANCIENT_STRUCTURE.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}