...
public class AncientTreeGrowers {
    public static final TreeGrower CRYSTAL_SKYROOT = new TreeGrower(
            "crystal_skyroot",
            Optional.empty(),
            Optional.of(AncientTreeFeatures.CRYSTAL_SKYROOT_TREE),
            Optional.empty()
    );
    ...
    public static final TreeGrower ENCHANTED_SKYROOT = new TreeGrower(
            ...
            Optional.empty(),
            Optional.empty(),
            Optional.of(AncientTreeFeatures.ENCHANTED_SKYROOT_TREE),
            Optional.of(AncientTreeFeatures.FANCY_ENCHANTED_SKYROOT_TREE),
            Optional.empty(),
            Optional.empty()
    );
    ...
    public static final TreeGrower SKYROOT_PINE_TREE = new TreeGrower(
            "skyroot_pine",
            Optional.empty(),
            Optional.of(AncientTreeFeatures.SKYROOT_PINE_TREE),
            Optional.empty()
    );
    ...
    public static final TreeGrower HIGHSPROOT = new TreeGrower(
            ...
            Optional.empty(),
            Optional.empty(),
            Optional.of(AncientTreeFeatures.HIGHSPROOT_TREE),
            Optional.of(AncientTreeFeatures.TALL_HIGHSPROOT_TREE),
            Optional.empty(),
            Optional.empty()
    );
    ...
    public static final TreeGrower SAKURA = new TreeGrower(
            ...
            Optional.empty(),
            Optional.empty(),
            Optional.of(AncientTreeFeatures.SAKURA_TREE),
            Optional.of(AncientTreeFeatures.TALL_SAKURA_TREE),
            Optional.empty(),
            Optional.empty()
    );
}